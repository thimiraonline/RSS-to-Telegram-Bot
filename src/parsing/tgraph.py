            ...
            async with self._fc_lock:  # block any other sending tries
                ...
                if retry_after >= 60:
                    ...
                    await self.create_account(short_name='RSStT', author_name='Generated by RSStT',
                                              author_url='https://github.com/thimiraonline/RSS-to-Telegram-Bot')
...
class TelegraphIfy:
    ...
    async def generate_page(self):
        ...
        if self.feed_title:
            ...
            self.telegraph_author_url = 'https://github.com/thimiraonline/RSS-to-Telegram-Bot'

        self.telegraph_title = self.title or 'Generated by RSStT'
        self.telegraph_html_content = (soup.decode() +
                                       '<p>Generated by '
                                       '<a href="https://github.com/thimiraonline/RSS-to-Telegram-Bot">RSStT</a>. '
